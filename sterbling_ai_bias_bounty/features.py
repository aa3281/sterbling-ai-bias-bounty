...
def main(
    ...
    # Superior feature engineering (better than notebook's minimal approach)
    ...
    if 'Loan_Approved' in df.columns:
        # Training data - exclude ID and target from features
        ...
        # Test data - exclude ID from features but keep it for submission
